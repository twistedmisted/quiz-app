...
public class QuestionDAO implements DAO<Question> {
    ...
    private static final String GET_QUESTION_BY_PROMPT = "SELECT * FROM questions WHERE prompt=(?);";

    private static final String GET_QUESTIONS_BY_QUIZ_ID = "SELECT * FROM questions WHERE quiz_id=(?);";

    private static final String DELETE_QUESTION = "DELETE FROM questions WHERE id=(?);";

    private static final String INSERT_QUESTION = "INSERT INTO questions (prompt, quiz_id) VALUES (?, ?);";

    private static final String GET_NUMBER_OF_QUESTIONS = "SELECT COUNT(*) FROM questions WHERE quiz_id=?;";
